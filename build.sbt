...
val Scala3 = "3.3.6"
ThisBuild / crossScalaVersions := Seq(Scala3, "2.13.17", "2.12.20")
...
lazy val otelApiV = "1.54.1"
lazy val otelTraceSdkV = "1.54.1"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.54.1",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.54.1",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.54.1",
        "io.opentelemetry" % "opentelemetry-sdk" % "1.54.1",
        "io.opentelemetry" % "opentelemetry-sdk-common" % "1.54.1",
