...
lazy val otelApiV = "1.63.0"
lazy val otelTraceSdkV = "1.63.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.63.0",
        ...
        "io.opentelemetry.semconv" % "opentelemetry-semconv" % "1.42.0" % Test,
