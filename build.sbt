...
lazy val otelApiV = "1.42.0"
lazy val otelTraceSdkV = "1.42.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      ...
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.42.0",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.42.0",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.42.0",
        "io.opentelemetry" % "opentelemetry-sdk" % "1.42.0",
        "io.opentelemetry" % "opentelemetry-sdk-common" % "1.42.0",
