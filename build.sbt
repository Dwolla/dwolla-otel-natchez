...
lazy val core = project.in(file("core"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry" % "opentelemetry-context" % "1.32.0",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.32.0",
      "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.32.0",
      ...
      "io.opentelemetry.contrib" % "opentelemetry-aws-xray-propagator" % "1.31.0-alpha",
