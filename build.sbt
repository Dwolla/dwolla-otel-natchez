...
lazy val otelApiV = "1.54.0"
lazy val otelTraceSdkV = "1.54.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.54.0",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.54.0",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.54.0",
