...
val Scala3 = "3.3.3"
ThisBuild / crossScalaVersions := Seq(Scala3, "2.13.13", "2.12.19")
...
lazy val otelApiV = "1.37.0"
lazy val otelTraceSdkV = "1.37.0"
...
lazy val core = project.in(file("core"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.37.0",
