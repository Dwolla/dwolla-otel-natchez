...
val Scala3 = "3.3.3"
ThisBuild / crossScalaVersions := Seq(Scala3, "2.13.14", "2.12.20")
...
lazy val otelApiV = "1.42.1"
lazy val otelTraceSdkV = "1.42.1"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      ...
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.42.1",
