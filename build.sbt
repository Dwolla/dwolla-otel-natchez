...
lazy val core = project.in(file("core"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry" % "opentelemetry-api" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-context" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-sdk" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-sdk-common" % "1.30.0",
      "io.opentelemetry" % "opentelemetry-sdk-trace" % "1.30.0",
      ...
      "io.opentelemetry.contrib" % "opentelemetry-aws-xray" % "1.29.0",
    )
  )
