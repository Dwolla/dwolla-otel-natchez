...
lazy val otelApiV = "1.53.0"
lazy val otelTraceSdkV = "1.53.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.53.0",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.53.0",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.53.0",
