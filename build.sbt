...
lazy val core = project.in(file("core"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      "io.opentelemetry" % "opentelemetry-context" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-sdk" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-sdk-common" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-sdk-trace" % "1.26.0",
      "io.opentelemetry" % "opentelemetry-semconv" % "1.24.0-alpha",
      "io.opentelemetry.contrib" % "opentelemetry-aws-resources" % "1.25.1-alpha",
