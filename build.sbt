...
lazy val otelApiV = "1.58.0"
lazy val otelTraceSdkV = "1.58.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.58.0",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.58.0",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.58.0",
        "io.opentelemetry" % "opentelemetry-sdk" % "1.58.0",
        "io.opentelemetry" % "opentelemetry-sdk-common" % "1.58.0",
