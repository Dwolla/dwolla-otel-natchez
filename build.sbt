...
lazy val catsEffectV = "3.6.2"
lazy val otelApiV = "1.52.0"
lazy val otelTraceSdkV = "1.52.0"
  ...
  .settings(
    ...
    libraryDependencies ++= {
      Seq(
        ...
        "io.opentelemetry" % "opentelemetry-context" % "1.52.0",
        "io.opentelemetry" % "opentelemetry-exporter-otlp" % "1.52.0",
        "io.opentelemetry" % "opentelemetry-extension-trace-propagators" % "1.52.0",
